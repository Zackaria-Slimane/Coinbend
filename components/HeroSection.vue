<template>
	<div id="hero-section" class="h-screen dark:bg-gray-900">
		<HeaderSection />
		<div class="overflow-hidden">
			...
			<div class="relative pt-2 pb-16 sm:pb-24">
				<main class="mt-10">
					<div class="mx-auto max-w-7xl">
						<div class="lg:grid lg:grid-cols-12 lg:gap-8">
							...
							<div class="mt-20 sm:mt-48 lg:col-span-6 lg:mt-0">
								<div style="backdrop-filter: blur(5px)"
									...
									<div class="border-t-2 border-gray-200 bg-gray-50 px-4 py-6 sm:px-10 hidden">
										<p class="text-xs leading-5 text-gray-500">
											...
											<a href="#" class="font-medium text-gray-900 hover:underline">Data
												Policy</a>
											and
